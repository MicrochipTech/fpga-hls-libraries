...
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 86 / 87 / 86.01                  | 1 / 2 / 1.01                |       7e-06 |     1.5e-05 |   2914 |   4969 |      0 |       0 |      10 | 490.196 MHz           |
| sqrt_cmath | 5 / 238 / 205.24                 | 6 / 239 / 206.39            |       0     |     0       |  13770 |  17945 |      9 |       0 |       0 | 298.954 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 102 / 103 / 102.01               | 1 / 2 / 1.01                |     9.9e-05 |    0.000244 |   3978 |   6510 |      0 |       0 |       8 | 397.298 MHz           |
| sqrt_cmath | 5 / 238 / 205.24                 | 6 / 239 / 206.39            |     0       |    0        |  13770 |  17945 |      9 |       0 |       0 | 288.684 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 185 / 186 / 185.20               | 1 / 2 / 1.25                |    0.052281 |    0.159138 |   8754 |  20341 |      0 |       1 |      28 | 371.885 MHz           |
| sqrt_cmath | 5 / 238 / 205.24                 | 6 / 239 / 206.39            |    0        |    0        |  13770 |  17945 |      9 |       0 |       0 | 291.375 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 102 / 103 / 102.01               | 1 / 2 / 1.01                |     2.9e-05 |     0.00012 |   3978 |   6510 |      0 |       0 |       8 | 384.911 MHz           |
| sqrt_cmath | 5 / 238 / 205.24                 | 6 / 239 / 206.39            |     0       |     0       |  13770 |  17945 |      9 |       0 |       0 | 295.334 MHz           |
