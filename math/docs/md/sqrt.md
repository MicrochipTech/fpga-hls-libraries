...
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 86 / 87 / 86.01                  | 1 / 2 / 1.01                |       7e-06 |     1.5e-05 |   2866 |   5025 |      0 |       0 |      10 | 532.765 MHz           |
| sqrt_cmath | 6 / 239 / 206.24                 | 6 / 239 / 206.39            |       0     |     0       |  12661 |  16278 |      6 |       0 |       0 | 291.206 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 102 / 103 / 102.01               | 1 / 2 / 1.01                |     9.9e-05 |    0.000244 |   4003 |   6623 |      0 |       0 |       8 | 425.170 MHz           |
| sqrt_cmath | 6 / 239 / 206.24                 | 6 / 239 / 206.39            |     0       |    0        |  12661 |  16278 |      6 |       0 |       0 | 267.237 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 185 / 186 / 185.20               | 1 / 2 / 1.25                |    0.052281 |    0.159138 |   8810 |  21135 |      0 |       1 |      28 | 346.021 MHz           |
| sqrt_cmath | 6 / 239 / 206.24                 | 6 / 239 / 206.39            |    0        |    0        |  12661 |  16278 |      6 |       0 |       0 | 269.469 MHz           |
...
| Name       | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|------------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| sqrt_hls   | 102 / 103 / 102.01               | 1 / 2 / 1.01                |     2.9e-05 |     0.00012 |   4003 |   6623 |      0 |       0 |       8 | 383.730 MHz           |
| sqrt_cmath | 6 / 239 / 206.24                 | 6 / 239 / 206.39            |     0       |     0       |  12661 |  16278 |      6 |       0 |       0 | 297.177 MHz           |
