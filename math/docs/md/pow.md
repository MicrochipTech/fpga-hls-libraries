...
|-----------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| pow_hls   | 235 / 236 / 235.17               | 1 / 2 / 1.20                |    0.000237 |    0.000732 |  21100 |  30377 |    131 |      13 |      41 | 309.310 MHz           |
| pow_cmath | 477 / 477 / 477.00               | 43 / 43 / 43.00             |    0        |    0        |  19510 |  27879 |      9 |       8 |       0 | 252.080 MHz           |
...
| Name      | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|-----------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| pow_hls   | 149 / 150 / 149.06               | 1 / 2 / 1.06                |           0 |           0 |   6698 |  10480 |     44 |       7 |      13 | 353.982 MHz           |
| pow_cmath | 477 / 477 / 477.00               | 43 / 43 / 43.00             |           0 |           0 |  19510 |  27879 |      9 |       8 |       0 | 258.465 MHz           |
...
| Name      | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|-----------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| pow_hls   | 147 / 148 / 147.00               | 1 / 2 / 1.00                |     8.7e-05 |    0.000732 |   5770 |   9300 |     35 |       7 |      10 | 334.448 MHz           |
| pow_cmath | 477 / 477 / 477.00               | 43 / 43 / 43.00             |     0       |    0        |  19510 |  27879 |      9 |       8 |       0 | 264.971 MHz           |
...
| Name      | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|-----------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| pow_hls   | 147 / 148 / 147.00               | 1 / 2 / 1.00                |    0.000179 |    0.000714 |   5770 |   9300 |     35 |       7 |      10 | 341.647 MHz           |
| pow_cmath | 477 / 477 / 477.00               | 43 / 43 / 43.00             |    0        |    0        |  19510 |  27879 |      9 |       8 |       0 | 258.065 MHz           |
...
| Name      | Latency [cycles] (min/max/avg)   | II [cycles] (min/max/avg)   |   Avg Error |   Max Error |   LUTs |   DFFs |   DSPs |   LSRAM |   uSRAM | Estimated Frequency   |
|-----------|----------------------------------|-----------------------------|-------------|-------------|--------|--------|--------|---------|---------|-----------------------|
| pow_hls   | 147 / 148 / 147.00               | 1 / 2 / 1.00                |     3.8e-05 |    0.000244 |   5770 |   9300 |     35 |       7 |      10 | 334.113 MHz           |
| pow_cmath | 477 / 477 / 477.00               | 43 / 43 / 43.00             |     0       |    0        |  19510 |  27879 |      9 |       8 |       0 | 236.463 MHz           |
