...
libero script:MPFS_DISCOVERY_KIT_REFERENCE_DESIGN.tcl script_args:VERIFYTIMING+PLACEROUTE+SYNTHESIZE+SMARTHLS:$HLS_PATH+EXPORT_FPE:$prjDir+HSS_UPDATE:1 logfile:disco_kit_sin_performance.log
