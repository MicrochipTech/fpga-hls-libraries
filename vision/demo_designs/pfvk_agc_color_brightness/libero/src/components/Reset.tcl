...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:EXT_RST_N" "EXT_RST_N"}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_1:EXT_RST_N" "EXT_RST_N"}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_2:EXT_RST_N" "EXT_RST_N"}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_INIT_MONITOR_C0_0:FABRIC_POR_N" "CORERESET_PF_C1_2:FPGA_POR_N"}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_INIT_MONITOR_C0_0:SRAM_INIT_FROM_SPI_DONE" "AND2_2:A"}
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_INIT_MONITOR_C0_0:SRAM_INIT_DONE" "AND2_2:A"}
# sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {AND2_2:A} -value {VCC}
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_2:Y" "CORERESET_PF_C1_2:INIT_DONE"}
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_INIT_MONITOR_C0_0:DEVICE_INIT_DONE" \
    "DEVICE_INIT_DONE" \
    "AND2_2:B" \
}
