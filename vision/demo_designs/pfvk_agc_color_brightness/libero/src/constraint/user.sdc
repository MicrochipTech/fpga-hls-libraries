...
set_input_delay 2 -max  -clock { CLK_IN } [ get_ports { HDMI_SCL HDMI_SDA UART_RX CAM2_SCL CAM2_SDA } ]
set_input_delay 1 -min  -clock { CLK_IN } [ get_ports { HDMI_SCL HDMI_SDA UART_RX CAM2_SCL CAM2_SDA } ]
set_output_delay 2 -max  -clock { CLK_IN } [ get_ports { UART_TX CAM2_RST CAM2_SCL CAM2_SDA CAM_CLK_EN GPIO_OUT_0[0] GPIO_OUT_0[1] GPIO_OUT_0[2] GPIO_OUT_0[3] HDMI_SCL HDMI_SDA } ]
set_output_delay 1 -min  -clock { CLK_IN } [ get_ports { UART_TX CAM2_RST CAM2_SCL CAM2_SDA CAM_CLK_EN GPIO_OUT_0[0] GPIO_OUT_0[1] GPIO_OUT_0[2] GPIO_OUT_0[3] HDMI_SCL HDMI_SDA } ]
...
set_clock_uncertainty -setup 0.15 [ get_clocks { IMX334_IF_TOP_0/PF_CCC_C2_0/PF_CCC_C2_0/pll_inst_0/OUT0 } ]
...
set_clock_uncertainty -setup 0.15 [ get_clocks { IMX334_IF_TOP_0/PF_IOD_GENERIC_RX_C0_1/PF_IOD_0/PF_CLK_DIV_FIFO/I_CDD/Y_DIV } ]
