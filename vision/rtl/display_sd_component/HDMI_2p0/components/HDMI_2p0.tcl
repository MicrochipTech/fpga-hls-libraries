...
sd_create_scalar_port -sd_name ${sd_name} -port_name {AXIS_tlast} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {AXIS_tvalid} -port_direction {IN}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {AXIS_tready_O} -port_direction {OUT}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXIS_tdata} -port_direction {IN} -port_range {[95:0]}
sd_create_bus_port -sd_name ${sd_name} -port_name {AXIS_tuser} -port_direction {IN} -port_range {[0:0]}


# Create top level Bus interface Ports
sd_create_bif_port -sd_name ${sd_name} -port_name {AXIS} -port_bif_vlnv {AMBA:AMBA4:AXI4Stream:r0p0_1} -port_bif_role {slave} -port_bif_mapping {\
"TVALID:AXIS_tvalid" \
"TREADY:AXIS_tready_O" \
"TDATA:AXIS_tdata" \
"TLAST:AXIS_tlast" \
"TUSER:AXIS_tuser" } 

# Add AXIS_To_VGA_Converter_0 instance
sd_instantiate_hdl_core -sd_name ${sd_name} -hdl_core_name {AXIS_To_VGA_Converter} -instance_name {AXIS_To_VGA_Converter_0}
# Exporting Parameters of instance AXIS_To_VGA_Converter_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {AXIS_To_VGA_Converter_0} -params {\
"C_WIDTH:8" \
"DEBUBBLE:1" \
"FIFO_DEPTH:32" \
"PIXEL_PER_CLK:4" \
...
"TUSER_WIDTH:1" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {AXIS_To_VGA_Converter_0}
sd_update_instance -sd_name ${sd_name} -instance_name {AXIS_To_VGA_Converter_0}
sd_invert_pins -sd_name ${sd_name} -pin_names {AXIS_To_VGA_Converter_0:reset}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {BIBUF_0:E} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {PF_XCVR_ERM_C0_0:LANE1_RX_SLIP} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {PF_XCVR_ERM_C0_0:LANE2_RX_SLIP} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {PF_XCVR_ERM_C0_0:LANE3_RX_SLIP} -value {GND}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:clk" "HDMI_TX_C0_0:SYS_CLK_I" "LANE0_TX_CLK_R" "PF_XCVR_ERM_C0_0:LANE0_TX_CLK_R" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:data_enable_O" "HDMI_TX_C0_0:DATA_VALID_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:hsync_O" "HDMI_TX_C0_0:H_SYNC_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:reset" "HDMI_TX_C0_0:RESET_N_I" "PF_XCVR_ERM_C0_0:LANE0_PCS_ARST_N" "PF_XCVR_ERM_C0_0:LANE0_PMA_ARST_N" "PF_XCVR_ERM_C0_0:LANE1_PCS_ARST_N" "PF_XCVR_ERM_C0_0:LANE1_PMA_ARST_N" "PF_XCVR_ERM_C0_0:LANE2_PCS_ARST_N" "PF_XCVR_ERM_C0_0:LANE2_PMA_ARST_N" "PF_XCVR_ERM_C0_0:LANE3_PCS_ARST_N" "PF_XCVR_ERM_C0_0:LANE3_PMA_ARST_N" "RESET_N_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:vsync_O" "HDMI_TX_C0_0:V_SYNC_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:B_O" "HDMI_TX_C0_0:DATA_B_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:G_O" "HDMI_TX_C0_0:DATA_G_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS_To_VGA_Converter_0:R_O" "HDMI_TX_C0_0:DATA_R_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIS" "AXIS_To_VGA_Converter_0:AXIS" }
